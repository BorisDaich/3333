package biz.daich.tambour.shlicht.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, biz.daich.tambour.shlicht.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, biz.daich.tambour.shlicht.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, biz.daich.tambour.shlicht.domain.User.class.getName());
