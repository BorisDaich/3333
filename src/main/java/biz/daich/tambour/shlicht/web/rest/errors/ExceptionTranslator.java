...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof biz.daich.tambour.shlicht.service.EmailAlreadyUsedException ||
            ex instanceof biz.daich.tambour.shlicht.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof biz.daich.tambour.shlicht.service.InvalidPasswordException
