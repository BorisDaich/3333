...
import { EntityArrayResponseType, ImagesService } from '../service/images.service';
...
export class ImagesComponent implements OnInit {
  ...
  trackId = (_index: number, item: IImages): string => this.imagesService.getImagesIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IImages[] | null): IImages[] {
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.imagesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
