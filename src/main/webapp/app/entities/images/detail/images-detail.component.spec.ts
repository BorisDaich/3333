...
describe('Images Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ImagesDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
  ...
  describe('OnInit', () => {
    it('Should load images on init', async () => {
      ...
      // THEN
      expect(instance.images).toEqual(expect.objectContaining({ id: 'ABC' }));
    });
  });
  ...
  describe('byteSize', () => {
    it('Should call byteSize from DataUtils', () => {
      ...
      const fixture = TestBed.createComponent(ImagesDetailComponent);
